...
public class BaseTest {
    ...
    public void injectCookiesToBrowser(List<Cookie> restAssuredCookies){
        List<org.openqa.selenium.Cookie> seleniumCookies = CookiesUtils.convertRestAssuredCookiesToSelenium(restAssuredCookies);
    ...
    public void takeScreenshot(File destFile){
        ...
        try {
            ...
            InputStream ss = new FileInputStream(destFile);
            Allure.attachment("screenshot", ss);
        } catch (IOException e) {
